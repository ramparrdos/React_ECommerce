...
const Dashboard = () => {
    ...
    <>
      <Navbar />
      <div className="px-20 py-10 space-y-12 bg-gray-100">
        <h1 className="text-4xl font-bold mb-8">Dashboard</h1>

        <div className="grid grid-cols-4 gap-8">
          <div className="bg-white text-gray-900 shadow-lg rounded-2xl p-8 transition duration-300 ease-in-out hover:bg-gray-900 hover:text-white">
            <h2 className="text-2xl font-semibold mb-4">Total Products</h2>
            <p className="text-3xl">{totalProducts}</p>
          </div>

          <div className="bg-white text-gray-900 shadow-lg rounded-2xl p-8 transition duration-300 ease-in-out hover:bg-gray-900 hover:text-white">
            <h2 className="text-2xl font-semibold mb-4">Total Categories</h2>
            <p className="text-3xl">{totalCategories}</p>
          </div>

          <div className="bg-white text-gray-900 shadow-lg rounded-2xl p-8 transition duration-300 ease-in-out hover:bg-gray-900 hover:text-white">
            <h2 className="text-2xl font-semibold mb-4">Average Price</h2>
        ...
        <div>
          <h2 className="text-3xl font-semibold mb-8">Product Previews</h2>
